...
<title>2026 Kestria Global Conference in Singapore - Feedback</title>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .stat {
    ...
    padding: 24px 28px;
    margin: 22px 0 38px;
    box-shadow: 0 10px 24px rgba(12,35,64,0.14);
  }
  .stat-num {
  ...
  .stat-of { font-size: 0.72em; font-weight: 600; opacity: 0.92; }
  ...
  @media (max-width: 560px) {
    .stat { flex-direction: column; align-items: flex-start; gap: 8px; padding: 20px; }
  ...
  @media print {
    body { background: #fff; }
    .stat { box-shadow: none; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
...
<body>
  ...
  <main class="wrap">
    ...
    <p class="subtitle">Post-conference feedback summary</p>

    <div class="stat">
      <div class="stat-num">__RESP__<span class="stat-of"> of __TOTAL__</span></div>
      <div class="stat-label">
        <strong>participants</strong> shared their feedback
      </div>
    </div>
